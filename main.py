...
def better_than_average(class_points, your_points):
    ...
    for i in class_points:
        classAverage += i
    classAverage=classAverage/len(class_points)
...
def bmi2(weight, height):       #autre facon de faire celui du dessus
    b = weight / height ** 2
...
def is_isogram(string):
    string = string.lower()
    string2=set(string) #set fait un ensemble, donc si on a des doublons ils seront supprimés
...
#print(nb_year(1000,5,50,1400))
#print(DNA_strand('TGAC'))
#print(number_to_string(5))
#print(bmi(85,1.76))
#print(invert([1,-2,3]))
#print(is_isogram('azerty'))
#print(rps('rock','rock'))
print(no_space('caca sur ton  doigt'))
